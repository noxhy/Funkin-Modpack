...
@onready var options: Dictionary = {
	...
	"Noah Engine": [
		["Noah", load("uid://n4kx1aek2ssv")],
		["data5", load("uid://dqpr4spnp76yr")],
		["PaintVG", load("uid://b8dxdsdrlij1m")]
	],
	
	"Friday Night Funkin\'": [
		["The Funkin\' Crew", load("uid://d032y0pbv8348")],
	]
...
@onready var option_stats: Dictionary = {
	"Noah": ["Lead Developer", "link", "https://www.youtube.com/channel/UCH5BbTqMfiO-Cxhtx3drsqA"],
	"PaintVG": ["Artist", "link", "https://x.com/JustPaintBucket"],
	"The Funkin\' Crew": ["Friday Night Funkin\' game and assets", "link", "https://www.newgrounds.com/portal/view/770371"],
	"data5": ["Co-Developer", "link", "https://x.com/_data5?s=20"]
}
